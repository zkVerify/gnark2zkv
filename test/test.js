...
describe("Convert", function () {
  describe("Proof", function () {
    describe("BN128", function () {
      it("should succeed", async function () {
        const proof = await convertProof(proofData.bn128.in, "bn128");
        assert.equal(
    ...
    describe("BLS12-381", function () {
      it("should succeed", async function () {
        const proof = await convertProof(proofData.bls12381.in, "bls12381");
        assert.equal(
          JSON.stringify(proof),
  ...
  describe("Vk", function () {
    describe("BN128", function () {
      it("should succeed", async function () {
        const vk = await convertVk(vkData.bn128.in, "bn128");
    ...
    describe("BLS12-381", function () {
      it("should succeed", async function () {
        const vk = await convertVk(vkData.bls12381.in, "bls12381");
