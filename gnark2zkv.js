...
program
  .name("gnark2zkv")
  .description(
    "convert Groth16 artifacts generated with gnark to the format accepted by zkVerify pallet-settlement-groth16"
  )
  .version("0.1.0");
...
program
  ...
  .argument(
    "<public>",
    "JSON file containing the public inputs in gnark format"
  )
  .addOption(
